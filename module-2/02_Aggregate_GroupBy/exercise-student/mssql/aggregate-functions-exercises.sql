...
SELECT
	...
	ABS(gnp-gnpold) AbsoluteDifference,
	name
FROM
	country
WHERE
	gnp IS NOT NULL AND gnpold IS NOT NULL
ORDER BY
	ABS(gnp-gnpold) ASC
...
SELECT
	max(population) AS LargestCityPopulation,
	countrycode
FROM
	city
GROUP BY

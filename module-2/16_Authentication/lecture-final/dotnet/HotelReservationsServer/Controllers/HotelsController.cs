...
namespace HotelReservations.Controllers
{
    [Route("/")]
    [ApiController]
    //[Authorize(Roles ="admin,hotelmanager,zeus")]
    public class HotelsController : ControllerBase
    {
        ...
        public ActionResult<Reservation> GetReservation(int id)
        {
            ...
            // IF reservation also had the booking user ID...
            // If the currently authenticated user is not an admin / hotel manager, AND their ID isn't the booking user ID
            // Then we return 403 Forbidden via the Forbid method

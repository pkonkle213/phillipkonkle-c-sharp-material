...
namespace HotelReservations
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IHotelDao>(sp => new HotelDao()); // When you need an IHotelDao, use this new HotelDao
            services.AddSingleton<IReservationDao>(sp => new ReservationDao()); // When you need an IReserv.. use this...
        }

...
-- Notes:
-- ==========================================================================
--   IMPORTANT NOTE: For the GNP column, 1 is equal to $1,000,000 in US Dollars (1 million dollars)
-- ==========================================================================
...
SELECT * FROM city WHERE countrycode = 'USA' AND population BETWEEN 1000000 AND 2000000;

-- 14. The name and region of all countries in North or South America except for countries in the Caribbean (27 rows)
SELECT * FROM country WHERE region != 'Caribbean' AND (continent = 'North America' OR continent = 'South America');
...
SELECT gnp/population AS "per captia GNP" FROM country WHERE continent = 'Europe';

-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
SELECT 2019-indepyear AS "Years since Independence" FROM country WHERE indepyear IS NOT NULL;
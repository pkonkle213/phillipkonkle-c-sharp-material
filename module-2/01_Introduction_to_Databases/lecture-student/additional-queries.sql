-- BETWEEN
-- The name and population of all cities with a population of greater than 1 million people and less than 1 billion people
...
-- Note: GNP is stored where a GNP of 1 is equal to 1 million dollars

-- The name, continent, GNP, and average life expectancy of all countries in Africa or Asia 
-- that have an average life expectancy of at least 70 years and a GNP between $1 billion and $100 billion dollars
-- Note: GNP is stored where a GNP of 1 is equal to 1 million dollars